...
def dynamic_longest_palindrome(s: str) -> str:
    """
...
def brute_force_longest_palindrome(s: str) -> str:
    """
...
assert expand_around_center("aaaa") == "aaaa"
assert expand_around_center("babad") == "bab"
assert expand_around_center("cbbd") == "bb"
assert expand_around_center("abacab") == "bacab"
