...
def letterCombosRecursive(digits):
    """
    Source: leetcode
    Recursive solution
    """
...
assert letterCombinations('999') == ["www","wwx","wwy","wwz","wxw","wxx","wxy","wxz","wyw","wyx","wyy","wyz","wzw","wzx","wzy","wzz","xww","xwx","xwy","xwz","xxw","xxx","xxy","xxz","xyw","xyx","xyy","xyz","xzw","xzx","xzy","xzz","yww","ywx","ywy","ywz","yxw","yxx","yxy","yxz","yyw","yyx","yyy","yyz","yzw","yzx","yzy","yzz","zww","zwx","zwy","zwz","zxw","zxx","zxy","zxz","zyw","zyx","zyy","zyz","zzw","zzx","zzy","zzz"]
assert letterCombinations('2') == ['a', 'b', 'c']

assert letterCombosRecursive('23') == ["ad", "ae", "af", "bd", "be", "bf", "cd", "ce", "cf"] 
